...
YY_BUFFER_STATE turtle_lexer__scan_bytes (yyconst char *bytes,yy_size_t len ,yyscan_t yyscanner );
...
yy_size_t turtle_lexer_get_leng (yyscan_t yyscanner );
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE turtle_lexer__scan_bytes  (yyconst char * yybytes, yy_size_t  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
