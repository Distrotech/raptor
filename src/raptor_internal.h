...
void raptor_parser_start_graph(raptor_parser* parser, raptor_term* term, int is_declared);
void raptor_parser_end_graph(raptor_parser* parser, raptor_term* term, int is_declared);
